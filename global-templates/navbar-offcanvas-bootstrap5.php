...
<!-- end custom logo -->
                ...
                <form class="d-lg-flex d-none">
                    <a class="button button--state-active fs-20 fw-bold rounded-10 shadow" href="<?php echo esc_url( home_url( '/appointment' ) ); ?>"><?php esc_html_e('Make
                        Appointment', 'medplus')?></a>
                </form>
