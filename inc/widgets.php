 ...
 */
add_filter( 'dynamic_sidebar_params', 'medplus_widget_classes' );

if ( ! function_exists( 'medplus_widget_classes' ) ) {
	 ...
	 * @return array $params
	 */
	function medplus_widget_classes( $params ) {
...
} // End of if function_exists( 'medplus_widget_classes' ).

add_action( 'widgets_init', 'medplus_widgets_init' );

if ( ! function_exists( 'medplus_widgets_init' ) ) {
	/**
	...
	function medplus_widgets_init() {
		register_sidebar(
			array(
				'name'          => __( 'Right Sidebar', 'medplus' ),
				'id'            => 'right-sidebar',
				'description'   => __( 'Right sidebar widget area', 'medplus' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Left Sidebar', 'medplus' ),
				'id'            => 'left-sidebar',
				'description'   => __( 'Left sidebar widget area', 'medplus' ),
				'before_widget' => '<aside id="%1$s" class="widget %2$s">',
				'after_widget'  => '</aside>',
				'before_title'  => '<h3 class="widget-title">',
				'after_title'   => '</h3>',
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Slider', 'medplus' ),
				'id'            => 'hero',
				'description'   => __( 'Hero slider area. Place two or more widgets here and they will slide!', 'medplus' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Hero Canvas', 'medplus' ),
				'id'            => 'herocanvas',
				'description'   => __( 'Full size canvas hero area for Bootstrap and other custom HTML markup', 'medplus' ),
				'before_widget' => '',
				'after_widget'  => '',
				'before_title'  => '',
				'after_title'   => '',
		...
		register_sidebar(
			array(
				'name'          => __( 'Top Full', 'medplus' ),
				'id'            => 'statichero',
				'description'   => __( 'Full top widget with dynamic grid', 'medplus' ),
		...
		register_sidebar(
			array(
				'name'          => __( 'Footer Full', 'medplus' ),
				'id'            => 'footerfull',
				'description'   => __( 'Full sized footer widget with dynamic grid', 'medplus' ),
...
} // End of function_exists( 'medplus_widgets_init' ).
