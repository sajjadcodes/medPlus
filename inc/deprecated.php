...
if ( ! function_exists( 'medplus_adjust_body_class' ) ) {
	 ...
	 */
	function medplus_adjust_body_class( $classes ) {
...
if ( ! function_exists( 'medplus_slbd_count_widgets' ) ) {
	/**
	 ...
	 * @deprecated 0.8.9
	 */
	function medplus_slbd_count_widgets( $sidebar_id ) {
...
function deprecated_translations() {
	array(
		__( 'It looks like nothing was found at this location. Maybe try one of the links below or a search?', 'medplus' ),
		__( 'Previous', 'medplus' ),
		__( 'Next', 'medplus' ),
		__( 'About:', 'medplus' ),
		__( 'Profile', 'medplus' ),
		__( 'Posts by', 'medplus' ),
		__( 'Permanent Link:', 'medplus' ),
		__( 'in', 'medplus' ),
		__( 'Edit', 'medplus' ),
	);
}
