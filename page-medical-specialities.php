                ...
                <article class="overflow-hidden pt-4">
                    <div class="row row-cols-1 row-cols-md-3 g-2 g-md-3 text-center">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-1.png" alt="Medical Specialiest">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-2.png" alt="Medical Specialiest">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-3.png" alt="Medical Specialiest">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-4.png" alt="Medical Specialiest">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-5.png" alt="Medical Specialiest">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-6.png" alt="Medical Specialiest">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-7.png" alt="Medical Specialiest">
                        ...
                        <div class="col">
                            <div class="med-card shadow border p-3 rounded-20">
                                <span class="d-flex align-items-center justify-content-center">
                                    <img src="<?php echo get_template_directory_uri() ?>./assets/images/medi-specialiest-8.png" alt="Medical Specialiest">
